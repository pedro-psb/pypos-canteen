...
class ReportSummary:
    ...
    def get_less_sales(cls):
        ...
        result = {"product": less_sold["product"], "share": round(share_percentage, 2)}
        return result
